...
def upgrade():
    ...
    op.add_column('profiles', sa.Column('binance_seller_name', sa.String(), nullable=True))
    op.add_column('profiles', sa.Column('binance_seller_nickname', sa.String(), nullable=True))
    op.add_column('profiles', sa.Column('binance_seller_mobile_phone', sa.String(), nullable=True))
    
    op.add_column('clients', sa.Column('binance_user_hash', sa.String(), nullable=True))
    op.create_index(op.f('ix_clients_binance_user_hash'), 'clients', ['binance_user_hash'], unique=True)
